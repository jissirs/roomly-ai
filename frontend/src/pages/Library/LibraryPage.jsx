    ...
    <div className="library-shell">
      <header className="library-topbar">
        ...
        <div className="library-account">
          <button
            type="button"
            className="library-account-trigger"
            onClick={() => setAccountMenuOpen((current) => !current)}
          >
            <span className="library-account-avatar">{displayName.charAt(0).toUpperCase()}</span>
            {displayName}
          ...
          {accountMenuOpen ? (
            <>
              <div className="library-menu-backdrop" onClick={() => setAccountMenuOpen(false)} />
              <div className="library-account-dropdown">
                <Link to="/settings" onClick={() => setAccountMenuOpen(false)}>
                  <Icon name="settings" size={14} /> ตั้งค่า
                </Link>
      ...
      <main className="library-content">
        ...
        {isLoading ? (
          <div className="library-empty"><p>กำลังโหลดโปรเจกต์...</p></div>
        ) : projects.length === 0 ? (
